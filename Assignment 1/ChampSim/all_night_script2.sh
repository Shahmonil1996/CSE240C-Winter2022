...
for i in hashed_perceptron-FNL-MMA280520-4kresetnext_line-spp_dev-no-lru-1core hashed_perceptron-FNL-MMA280520-2kresetnext_line-spp_dev-no-lru-1core hashed_perceptron-FNL-MMA280520-16kresetnext_line-spp_dev-no-lru-1core hashed_perceptron-FNL-MMA280520-32kresetnext_line-spp_dev-no-lru-1core; do
  while read line;  do
